...
### Syntax of URN According to [RFC2141](https://datatracker.ietf.org/doc/html/rfc2141#section-2):
...
<br />
And we do Deep Linking (the link that sends the user directly to the app
installed on their phone instead of using the web version of the app on the
browser)... we use URI Scheme for the app to enable deep linking. It is one of
the use cases for the URI Scheme.
{/* {% image "src/assets/images/posts/urlurnuri/deeplink.png", "","post-img", "lazy" %} */}
